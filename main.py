...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Shantanu')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Shantanu Sanjeev Shelke", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("shantanushelke719@gmail.com", True, self.white)
